<template>
  <div class="bg-blue-900 text-white">
    ...
    <div class="flex flex-col items-center flex flex-col justify-between">
      <select
        v-model="selectedOption"
        class="bg-yellow-600 p-2 rounded-md mb-4"
      >
        <option value="option1" selected>Work</option>
        <option value="option2">Sexy Stuff</option>
        <option value="option3">Birthday</option>
        <option value="option4">Homework</option>
        <option value="option5">Generic</option>
      </select>
    </div>
    ...
    <div
      class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 hover:shadow-3xl transform hover:-translate-y-3 transition duration-500 mb-50 pb-8 mt-20"
    >
      <div class="mb-2">
...
const reasons = [];
const message =
  "Welcome! We're excited to share with you that this webpage was created by Alejo, with the assistance of ChatGPT. Excuses and code were generated by ChatGPT, Alejo made sure to do all the minor adjustements. Bye!";
...
export default {
  ...
  data() {
    return {
      ...
      option4Array: [
        "My homework got stuck in the washing machine",
        "I was busy teaching my goldfish how to play chess",
        "My little brother used my homework as a canvas for his finger painting",
        "I had to help a group of aliens find their lost spaceship",
        "My homework got lost in a black hole",
        "I was too busy practicing my pirate accent",
        "My homework was taken by the Tooth Fairy as payment for a lost tooth",
        "I was busy trying to break the world record for the longest bubble gum bubble",
        "My homework was eaten by a dinosaur",
        "I had to help a group of squirrels build their winter nest",
        "My homework was used as a napkin at dinner",
        "I was busy building a rocket ship to go to the moon",
        "My homework was used as a parachute by my action figures",
        "I had to save the world from an alien invasion",
        "My homework was mistaken for a birthday present and given to someone else",
        "I was too busy building a sandcastle",
        "My homework was used as a blanket by my cat",
        "I had to help a group of bees find their lost hive",
        "My homework was attacked by a flock of seagulls",
        "I was too busy trying to catch my shadow",
        "My homework was used as a tissue by my little sister",
        "I had to help a group of frogs cross the road",
        "My homework was eaten by a giant ant",
        "I was too busy building a treehouse",
        "My homework was mistaken for a drawing and hung on the fridge",
        "My dog ate my homework",
        "Aliens abducted my pencil",
        "I left my homework on Mars",
        "I accidentally fed my homework to the paper shredder",
        "I was busy fighting crime as a superhero",
        "My little sister scribbled all over my homework",
        "I had to help my grandma with her knitting",
        "My computer crashed and erased all my work",
        "I was busy writing a novel",
        "My backpack got stolen by a gang of squirrels",
        "I had to save the world from a giant robot",
        "I was too busy watching cat videos on YouTube",
        "My homework got caught in a tornado",
        "I spilled soda all over my homework",
        "I accidentally set my homework on fire",
        "I was busy practicing my dance moves",
        "My homework is on strike and refuses to be done",
        "I got lost in a book and forgot about my homework",
        "My homework was attacked by a swarm of bees",
        "I had to dig a tunnel to escape from pirates",
        "I was too busy playing video games",
        "My little brother used my homework as a tissue",
        "I was helping the aliens build a spaceship",
        "My homework turned into a pumpkin at midnight",
        "I accidentally teleported my homework to another dimension",
        "I was too busy taking selfies",
        "I had to help my neighbor catch his runaway llama",
        "My homework was stolen by a group of ninja squirrels",
        "I was busy learning to speak dolphin",
        "My homework was taken hostage by a gang of unicorns",
        "I was too busy building a fort",
        "My homework is on vacation and won't be back until next week",
        "I had to save the world from a giant tomato",
        "My homework was eaten by a herd of wild buffalo",
        "I was too busy playing with my imaginary friend",
        "My homework got trapped in a time loop",
        "I had to help a stranded alien fix his spaceship",
        "My homework was hijacked by a group of space pirates",
        "I was too busy building a robot",
        "My homework was attacked by a swarm of mosquitoes",
        "I was too busy training my pet rock",
        "My homework was used as a doormat by my little brother",
        "I had to help a group of penguins build an igloo",
        "My homework was eaten by a giant monster",
        "I was too busy practicing my ninja moves",
        "My homework was used as a hat by a passing bird",
        "I had to save the world from a giant chicken",
        "My homework was stolen by a group of mischievous fairies",
        "I was too busy building a time machine",
        "My homework was used as a frisbee by my dog",
        "I had to help a lost alien find his way home",
        "My homework was attacked by a swarm of butterflies",
      ],
      result: "",
    };
  },
